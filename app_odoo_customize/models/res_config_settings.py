...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='https://www.eeic.com.cn/documentation/user/13.0/en/index.html')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='https://www.eeic.com.cn/documentation/13.0/index.html')
        app_support_url = ir_config.get_param('app_support_url', default='https://www.eeic.com.cn/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.eeic.com.cn/my-account/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.eeic.com.cn')
        app_ribbon_name = ir_config.get_param('app_ribbon_name', default='*eeic.com.cn')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "https://www.eeic.com.cn/documentation/user/13.0/en/index.html")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "https://www.eeic.com.cn/documentation/13.0/index.html")
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.eeic.com.cn/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.eeic.com.cn/my-account/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.eeic.com.cn")
        ir_config.set_param("app_ribbon_name", self.app_ribbon_name or "*eeic.com.cn")
